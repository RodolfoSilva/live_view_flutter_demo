...
config :flutter_server, FlutterServerWeb.Endpoint,
  ...
  check_origin: ["https://#{host}", "http://#{host}", "https://flutterappdemo.mavio.fr"],
...
config :flutter_server, FlutterServer.Mailer, adapter: Swoosh.Adapters.Local
